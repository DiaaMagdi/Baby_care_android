...
public class MyAdapter2 extends RecyclerView.Adapter<MyAdapter2.MyViewHolder> {
    ...
    public MyAdapter2(Context ct, String s1[], String s2[], String s3[],String s4[], int img[]) {
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        holder.text14.setText(data1[position]);
        holder.text15.setText(data2[position]);
        holder.text16.setText(data3[position]);
        holder.text17.setText(data4[position]);
